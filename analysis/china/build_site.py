...
STEP_KPIS = {
    ...
    2:  [('#1 电信', '骨干'),         ('44,862', '前 20 前缀数'),('38.9%', '占全国前缀')],
    3:  [('#3', 'AS 数排名'),         ('#3', '前缀排名'),        ('#16', 'IXP 排名')],
    4:  [('115,206', '中国总前缀'),   ('41% v6', 'IPv6 占比'),   ('5.2%', 'RPKI 覆盖')],
    ...
    20: [('0.212', '主权指数'),       ('全球第 9', '九国对比'),   ('五大维度', '综合')],
}
